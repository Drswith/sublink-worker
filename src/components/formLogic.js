    ...
    window.formData = function () {
        ...
        return {
            ...
            init() {
                ...
                this.includeClashDns = localStorage.getItem('includeClashDns') !== 'false';
                ...
                this.$watch('includeClashDns', val => localStorage.setItem('includeClashDns', val));
            ...
            getSubconverterUrl() {
                ...
                if (!this.includeClashDns) {
                    params.append('include_clash_dns', 'false');
                }
            ...
            async submitForm() {
                ...
                try {
                    ...
                    if (!this.includeClashDns) params.append('include_clash_dns', 'false');
            ...
            populateFormFromUrl(url) {
                ...
                this.includeClashDns = params.get('include_clash_dns') !== 'false';
                ...
                if (selectedRules || customRules || this.groupByCountry || !this.includeClashDns || this.enableClashUI ||
